...
@app.get("/")
def read_root():
    return {"message": "TDS Virtual TA is running. Use /query to ask questions."}

# ✅ Portal Compatibility (Dummy POST /)
@app.post("/")
async def handle_root_submission(request: Request):
    data = await request.json()
    return {
        "answer": "This is a placeholder response. Please use the /query endpoint for actual answers.",
        "links": []
    }

@app.post("/api")
async def alias_query_route(request: QueryRequest):
